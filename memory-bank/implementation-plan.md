...
10. **Seed the database with scenario seeds (without full stories)**
...
11. **Design the navigation structure**
...
12. **Set up basic typography and reading-friendly layout**
...
13. **Implement the Categories page**
...
14. **Implement the Places listing page with filtering**
...
15. **Implement the Scenarios listing page**
...
16. **Wire up breadcrumb navigation for hierarchical browsing**
...
17. **Implement the Story detail route**
...
18. **Connect Scenarios to Stories**
...
19. **Apply reading-focused layout to the Story page**
...
20. **Implement the Home page hero section**
...
21. **Display category and place overviews on Home**
...
22. **Implement the Today's Scenario logic**
...
23. **Create the Today's Scenario card component**
...
24. **Extend data model to store story bodies and audio references**
...
25. **Define vocabulary and highlight linking strategy**
...
26. **Seed vocabulary items for a pilot story**
...
27. **Render highlighted phrases in the Story text**
...
28. **Add phrase tooltips with meanings and translations**
...
29. **Build the vocabulary list panel on the Story page**
...
30. **Add translation visibility controls**
...
31. **Add basic font size controls**
...
32. **Prepare sample audio files for pilot stories**
...
33. **Link audio files in the Story data**
...
34. **Add audio controls to the Story page**
...
35. **Refine audio UX for reading and shadowing**
...
36. **Implement the About / Help page content**
...
37. **Explain highlight and translation behavior**
...
## Phase 9 — Analytics, Performance, and Accessibility

38. **Integrate basic analytics**
...
39. **Track key learning interactions**
...
41. **Perform accessibility checks**
...
## Phase 10 — Testing, QA, and Content Expansion

42. **Write unit tests for core components**
...
43. **Create E2E tests for main user flows**
...
44. **Conduct manual QA on multiple devices**
...
45. **Add more stories and vocabulary items**
...
## Phase 11 â€?Deployment and Environments

46. **Set up staging and production environments**
...
47. **Configure environment variables for each environment**
...
48. **Run smoke tests after each deployment**
...
49. **Monitor real-user behavior and iterate**
